...
export const Home = () => {
  return (
    <section className="my-auto flex w-full flex-1 flex-col items-center gap-8 lg:flex-row">
      {/* AI Therapist Card - Now first */}
      <div className="flex flex-1 flex-col rounded-lg bg-white px-6 shadow-md sm:px-8">
      ...
      {/* AI Interviewer Card - Now second */}
      <div className="flex flex-1 flex-col rounded-lg bg-white px-6 shadow-md sm:px-8">
